...
public class ChoiceQuestionController {
    ...
    @ApiOperation("删除选择题")
    @DeleteMapping("/deleteChoiceQuestion/{question_id}")
    public Result deleteChoiceQuestion(@PathVariable String question_id) {
        return Result.ok(choiceQuestionService.deleteChoiceQuestion(question_id));
    }
}
