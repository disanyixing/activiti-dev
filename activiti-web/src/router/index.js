...
},
{
  ...
  children: [{
    ...
    name: 'Leave',
    component: () =>
                    import ('@/views/workflow/apply/leave'),
  ...
  //   name: 'Loan',
  //   component: () =>
  //                   import ('@/views/workflow/apply/loan'),
...

{
  ...
  children: [{
    ...
    name: 'courseManager',
    component: () =>
                    import ('@/views/course/teacher/manage'),
  ...
  },
  {
    ...
    component: () =>
                    import ('@/views/course/student/info'),
  ...
  },
  {
    ...
    component: () =>
                    import ('@/views/course/student/enroll'),
...
// 课程通知 (Course Notification)
{
  ...
  children: [{
    ...
    component: () =>
                    import ('@/views/message/Form/mform.vue'),
...
// 教学反馈 (Teaching Feedback)
{
  ...
  children: [{
    ...
    name: 'ListFeedback',
    component: () =>
                    import ('@/views/teacherscore/director.vue'),
  ...
  },
  {
    ...
    component: () =>
                    import ('@/views/teacherscore/stu.vue'),
...
},
{
  ...
  },
  {
    ...
    name: 'Complete',
    component: () =>
                    import ('@/views/workflow/complete'),
